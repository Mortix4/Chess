...
namespace chessGraphics
{
    public partial class Form1 : Form
    {
        ...
        string[] messages =  {
            ...
            "Change Pawn to Queen - pawn in the last square",
            "Short castling",
            "Long castling",
            "Unknown message"
            };
        ...
        void playMove()
        {
            ...
            try
            {
                Invoke((MethodInvoker)delegate {
                    ...
                    else if (res.ToLower().StartsWith("change"))
                    {
                        ...
                        if (isCurPlWhite)
                        {
                            matBoard[dstSquare.Row, dstSquare.Col].BackgroundImage = getImageBySign('q');//white
                        }
                        else
                        {
                            matBoard[dstSquare.Row, dstSquare.Col].BackgroundImage = getImageBySign('Q');//black
                        }
                    ...
                    else if (res.ToLower().StartsWith("short"))
                    {

                        matBoard[dstSquare.Row, dstSquare.Col].BackgroundImage = getImageBySign('K');
                        matBoard[dstSquare.Row, dstSquare.Col - 1].BackgroundImage = getImageBySign('R');
                        matBoard[dstSquare.Row, dstSquare.Col].BackgroundImage = null;
                        matBoard[srcSquare.Row, srcSquare.Col].BackgroundImage = null;

                    }
                    else if (res.ToLower().StartsWith("long"))
                    {
                        matBoard[dstSquare.Row, dstSquare.Col].BackgroundImage = getImageBySign('K');
                        matBoard[dstSquare.Row, dstSquare.Col + 1].BackgroundImage = getImageBySign('R');
                        matBoard[dstSquare.Row, dstSquare.Col].BackgroundImage = null;
